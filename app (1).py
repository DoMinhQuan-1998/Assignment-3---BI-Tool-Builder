...
st.info(
    ...
    f"total charges, tech support status, and payment method. In the current filtered view, "
    ...
    f"electronic checks. That pattern suggests the strongest retention focus should be placed on short-term "
